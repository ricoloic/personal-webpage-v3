...
class Boid {
    ...
    flock(
        ...
        boids,
        {
            alignmentForce = FORCE.alignmentForce,
            cohesionForce = FORCE.cohesionForce,
            separationForce = FORCE.separationForce,
        } = FORCE
    ) {
        ...
        for (const boid of boids) {
            ...
            if (boid !== this) {
                ...
                if (distance < 35) {
                    steering3.add(this.p5.constructor.Vector.sub(this.pos, boid.pos).div(distance));
                    total3 += 1;
                }
            }
        }
